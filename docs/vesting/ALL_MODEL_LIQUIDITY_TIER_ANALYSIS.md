...
**Generated**: 2026-01-08T13:22:07.686018

**Runs**: 100 per model per scenario

**Investment reference**: $9,000

## Winner by liquidity tier (avg ROI across 10 scenarios)

### Tier: $20M
- **Winner (avg choppy ROI)**: **Hybrid Model** (-96.4%)
| Model | Avg choppy ROI | Avg brake rate |
|---|---:|---:|
| Hybrid Model | -96.4% | 100.0% |
| Harris Model | -96.7% | 100.0% |
| Hybrid Tokenomics (Solvency-Anchored) | -96.9% | 74.2% |
| Model A (ROI Optimized, Ingo CSV) | -97.0% | 100.0% |
| Hybrid C (Ingo CSV) | -97.3% | 77.3% |
| HybridC | -97.4% | 77.8% |
| Hybrid C Lite (Defaults, Ingo CSV) | -97.8% | 78.1% |
| Super Ultra Mega Sphincer | -97.9% | 79.4% |
| Hybrid B | -97.9% | 80.0% |
| Sphincer v5 (v3.0+) | -97.9% | 100.0% |
| Protocol v3.0 | -97.9% | 100.0% |
| Protocol v5.5 | -97.9% | 99.1% |
| Protocol v5.8 | -97.9% | 98.6% |
| Sphincer v4 | -98.0% | 80.0% |
| Sphincer v2 | -98.0% | 80.0% |
| Sphincer v3 | -98.2% | 87.3% |
| Hybrid C Lite+ (Final, Ingo CSV) | -98.3% | 90.0% |
| Protocol v7.0 | -98.4% | 100.0% |
| Original Model | -98.5% | 77.8% |
...
### Tier: $32M
- **Winner (avg choppy ROI)**: **Hybrid Model** (-93.1%)
| Model | Avg choppy ROI | Avg brake rate |
|---|---:|---:|
...
| Sphincer v5 (v3.0+) | -96.3% | 79.3% |
| Protocol v5.8 | -96.4% | 78.9% |
| Protocol v5.5 | -96.4% | 78.8% |
| Hybrid C Lite (Defaults, Ingo CSV) | -96.5% | 40.0% |
| Super Ultra Mega Sphincer | -96.6% | 46.5% |
| Hybrid B | -96.6% | 47.1% |
| Sphincer v4 | -96.8% | 58.2% |
| Sphincer v2 | -96.8% | 62.6% |
| Protocol v7.0 | -96.9% | 100.0% |
| Sphincer v3 | -97.1% | 70.0% |
...
| Model | Avg choppy ROI | Avg brake rate |
|---|---:|---:|
| Hybrid Model | -73.3% | 63.9% |
| Harris Model | -83.5% | 100.0% |
| Hybrid Tokenomics (Solvency-Anchored) | -84.4% | 0.0% |
| Model A (ROI Optimized, Ingo CSV) | -85.0% | 100.0% |
| Protocol v5.8 | -85.5% | 46.6% |
| Protocol v5.5 | -85.5% | 44.7% |
| Sphincer v5 (v3.0+) | -85.8% | 35.0% |
| Protocol v3.0 | -85.8% | 35.3% |
...
| Super Ultra Mega Sphincer | -89.3% | 0.0% |
| Hybrid B | -89.4% | 0.0% |
| Sphincer v4 | -90.0% | 0.0% |
| Sphincer v2 | -90.1% | 0.0% |
| Sphincer v3 | -90.9% | 7.4% |
| Hybrid C Lite+ (Final, Ingo CSV) | -91.3% | 10.1% |
| Original Model | -92.3% | 0.0% |
| Protocol v3.1 (Adjusted) | -93.6% | 79.6% |
...
| Model | Avg choppy ROI | Avg brake rate |
|---|---:|---:|
| Hybrid Model | -59.3% | 34.8% |
| Harris Model | -75.2% | 100.0% |
| Hybrid Tokenomics (Solvency-Anchored) | -76.5% | 0.0% |
| Protocol v5.8 | -76.9% | 34.9% |
| Protocol v5.5 | -76.9% | 34.7% |
| Model A (ROI Optimized, Ingo CSV) | -77.5% | 100.0% |
| Protocol v3.0 | -77.6% | 10.0% |
| Sphincer v5 (v3.0+) | -77.6% | 10.0% |
| Protocol v7.0 | -79.2% | 60.1% |
| Hybrid C (Ingo CSV) | -79.5% | 0.0% |
| HybridC | -80.5% | 0.0% |
| Protocol v5.7 | -81.6% | 54.0% |
| Protocol v5.3 | -81.6% | 53.7% |
| Hybrid C Lite (Defaults, Ingo CSV) | -83.5% | 0.0% |
| Super Ultra Mega Sphincer | -83.9% | 0.0% |
| Hybrid B | -84.1% | 0.0% |
| Sphincer v4 | -84.9% | 0.0% |
| Sphincer v2 | -85.1% | 0.0% |
| Sphincer v3 | -86.3% | 0.0% |
